...
const CELLPHONE_REPAIR_TEMPLATE: IndustryTemplate = {
  ...
  fieldDefinitions: [
    templateField('service_requests', 'device_type', 'Tipo de equipo', 'select', ['Laptop / Notebook', 'Microsoft Surface', 'MacBook', 'Tarjeta de video (GPU)', 'PC de escritorio', 'Control de consola', 'Consola', 'Celular / Smartphone', 'Tablet / iPad', 'Otro'], { required: true, field_order: 1, placeholder: 'Selecciona el equipo' }),
