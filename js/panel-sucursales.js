...
(function () {
    ...
    async function cargarTodo() {
        const [sucursales, productos, transferencias] = await Promise.all([
            fixService.request('listar_sucursales', { soloActivas: '', page: 1, pageSize: 100 }, 'GET'),
            fixService.request('listar_productos', { sucursalId: 'GLOBAL', page: 1, pageSize: 500 }, 'POST'),
            fixService.request('listar_transferencias_stock', { sucursalId: getSucursalActiva(), page: 1, pageSize: 100 }, 'GET')
        ]);
