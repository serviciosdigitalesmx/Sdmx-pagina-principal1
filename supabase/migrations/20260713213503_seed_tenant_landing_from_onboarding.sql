...
begin
  ...
  insert into public.tenants (
    name, slug, status, plan, contact_name, contact_email, contact_phone, trial_expires_at, branding, landing_content
  ) values (
    p_workshop_name, v_slug, 'active', 'starter', p_workshop_name, p_email, p_phone, v_trial_expires_at,
